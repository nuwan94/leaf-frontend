...
function Input({
  ...
  return (
    (<input
      ...
      data-slot="input"
      className={cn(
        // Always show a visible border in both themes, more visible in light mode
        "border border-gray-400 dark:border-gray-700 focus:border-blue-400 focus:dark:border-blue-500",
